  ...
  function(record, search, runtime) {
      ...
      function execute(scriptContext) {
          ...
          try {
            ...
            var rectype = scriptObj.getParameter({name: 'custscript_vs_transtype_testers'});
            var recid = scriptObj.getParameter({name: 'custscript_vs_transid_testers'});
            ...
            if (!invCreated) {
                ...
                var inventoryAdjustment = record.create({type: record.Type.INVENTORY_ADJUSTMENT,isDynamic: true,});
                  ...
                  inventoryAdjustment.setValue({fieldId: "custbody_vs_source",value: "Testers - " + internalID,});
                  if (customer){inventoryAdjustment.setValue({fieldId: "customer",value: customer,});}

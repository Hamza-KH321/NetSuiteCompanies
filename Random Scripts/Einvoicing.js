  ...
  function (encode, record, currentRecord, format, log) {
    ...
    function afterSubmit(scriptContext) {
      ...
      if (scriptContext.type != scriptContext.UserEventType.DELETE) {
        ...
        if (thisRecord.getValue('custbody_vs_timeoftheday') == null || thisRecord.getValue('custbody_vs_timeoftheday') == undefined) {
          return;
        ...
        var test = thisRecord.getValue('custbody_vs_timeoftheday');
        log.debug('test ' ,test)
        if (thisRecord.getValue('custbody_vs_timeoftheday') != null && thisRecord.getValue('custbody_vs_timeoftheday') != undefined &&  thisRecord.getValue('custbody_vs_timeoftheday')) {

 ...
 * @fileName MR || Semnox Integration Sales
 */
define(['N/sftp', 'N/file', 'N/record', 'N/search', 'N/log'],
    function (sftp, file, record, search, log) {
        ...
        function getYesterdayFilename() {
            return 'Malahi_Sales_Report_160426.csv';
        }

...
define(['N/record', 'N/search', 'N/runtime', 'N/log'], function (record, search, runtime, log) {
            ...
            var searchObj = search.create({
                ...
                filters:
                    [
                        ...
                        "AND",
                        ["status", "anyof", "4"], // from Nearly Expire to Expired
                        "AND",
    ...
    function reduce(context) {
        try {
            ...
            statusChangeRecord.setValue({ fieldId: 'previousstatus', value: 4 }); // Previous Status Near Expiry
            statusChangeRecord.setValue({ fieldId: 'revisedstatus', value: 5 }); // New Status Expired

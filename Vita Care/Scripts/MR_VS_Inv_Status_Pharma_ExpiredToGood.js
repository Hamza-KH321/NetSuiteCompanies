 ...
 * @fileName MR || Inv Stat Change Expired to Good Pharma
 */
        ...
        try {
            ...
            var searchObj = search.create({
                ...
                filters: [
                    ...
                    "AND",
                    ["status", "anyof", "5"], // From Expired to Good 
                    "AND",
                    ["available", "greaterthan", "0"],
                    "AND",
                    ["formulatext: CASE WHEN FLOOR({inventorynumber.expirationdate} - {today}) > 120 THEN 'T' ELSE 'F' END", "is", "T"],
                    // "AND",
                    ...
                    "AND",
                    [["formulatext: {item.class}", "startswith", "Pharma"], "OR", ["formulatext: {item.class}", "startswith", "Non Pharma"]],

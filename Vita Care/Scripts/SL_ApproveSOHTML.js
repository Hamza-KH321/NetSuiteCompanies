    ...
    function onRequest(context) {
        ...
        if (request.method === 'GET') {
            ...
            for (let i = 0; i < results.length; i++) {
                ...
                if (appState !== approvalLevel && appState !== 'General' && appState !== '') continue;
                if (appState === 'General' && approvalLevel !== '') continue;
            ...
            const form = ui.createForm({ title: 'Approve Sales Orders' });
...
<body>
  <form method="POST">
    ...
    <center><button type="submit">Approve Selected</button></center>
  </form>
</body>
</html>
`;
            ...
            const link = url.resolveScript({
                scriptId: 'customscript_vs_sl_approveso',
                deploymentId: 'customdeploy_vs_sl_approveso',
